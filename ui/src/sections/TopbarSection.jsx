                ...
                <div className="row">
                    <div className="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                        <div className="d-inline-flex align-items-center">
                            <a className="text-body pr-3" href="" aria-label="Phone"><i className="fa fa-phone-alt mr-2"></i>+40 729 868 263</a>
                    ...
                    <div className="col-md-6 text-center text-lg-right">
                        <div className="d-inline-flex align-items-center">
                            ...
                            <a className="text-body pl-3" href="h#" aria-label="Youtube">
